...
namespace Gfx
{
    ...
    void VkDebug::PopulateCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo)
    {
        createInfo = {};
    ...
    void VkDebug::Setup(VkInstance instance)
    {
        VkDebugUtilsMessengerCreateInfoEXT createInfo;
        PopulateCreateInfo(createInfo);

        VK_ASSERT(CreateDebugUtilsMessengerEXT(instance, &createInfo, nullptr, &Messenger), "failed to set up debug messenger!");
    }

    void VkDebug::Destroy(VkInstance instance)
    {
