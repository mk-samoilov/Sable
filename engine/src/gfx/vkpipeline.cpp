...
namespace Gfx
{
    ...
    void Pipeline::CreateGraphicsPipeline() {
        auto vertShaderCode = AssetsHelper::ReadFile("shaders/triangle.vert.spv");
        auto fragShaderCode = AssetsHelper::ReadFile("shaders/triangle.frag.spv");
        ...
        auto bindingDescription = Gfx::Mesh::Vertex::GetBindingDescription();
        auto attributeDescriptions = Gfx::Mesh::Vertex::GetAttributeDescriptions();
